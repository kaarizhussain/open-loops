...
function assignOwner(type, what, subject, solo) {
  ...
  if (solo) return 'you';
  /* The sentence decides; the subject only breaks a tie it left open. These used to be
   * concatenated and searched as one string, which let a channel name overrule the promise
   * inside it — the same sentence routed to the assistant in #offsite and to the executive
   * in #pricing, so every commitment in a channel named for review, pricing or decisions
   * went to the executive whatever it actually said. */
